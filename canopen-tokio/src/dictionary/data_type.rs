...
mod tests {
    ...
    fn test_default_value() {
        assert_eq!(DataType::Unknown.as_default_bytes(), vec![0x0]);
        assert_eq!(DataType::Boolean.as_default_bytes(), vec![0x0]);
        assert_eq!(DataType::Integer8.as_default_bytes(), vec![0x0]);
        assert_eq!(DataType::Integer16.as_default_bytes(), vec![0x0, 0x0]);
        assert_eq!(
            DataType::Integer32.as_default_bytes(),
            vec![0x0, 0x0, 0x0, 0x0]
        );
        assert_eq!(DataType::Unsigned8.as_default_bytes(), vec![0x0]);
        assert_eq!(DataType::Unsigned16.as_default_bytes(), vec![0x0, 0x0]);
        assert_eq!(
        ...
        assert_eq!(DataType::Domain.as_default_bytes(), vec![0x0]);
        assert_eq!(
            DataType::Real64.as_default_bytes(),
            vec![0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]
        );
        assert_eq!(
            DataType::Integer64.as_default_bytes(),
            vec![0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]
        );
        assert_eq!(
            DataType::Unsigned64.as_default_bytes(),
            vec![0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]
        );
    }
